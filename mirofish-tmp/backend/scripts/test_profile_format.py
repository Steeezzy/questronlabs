"""
Test if Profile format matches OASIS requirements
Verification:
1. Twitter Profile in CSV format
2. Reddit Profile in JSON format
"""
...
def test_profile_formats():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Testing Reddit JSON format
        print("\n2. Test Reddit Profile (JSON detail format)")
        print("-" * 40)
